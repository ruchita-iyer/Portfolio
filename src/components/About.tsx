...
const About: React.FC = () => {
  ...
  const skills = [
    { name: 'React.js', icon: <MonitorSmartphone size={20} /> },
        ...
        >
          ...
          <motion.div variants={itemVariants} className="md:col-span-2 glass-card rounded-3xl p-8 md:p-12 relative overflow-hidden group hover:bg-white/10 transition-colors duration-700 cursor-default">
            ...
            <div className="space-y-6 text-lg text-foreground/80 relative z-10 leading-relaxed font-light">
              <p>
                I am a Frontend Engineer with experience building scalable, high-performance web applications using React, TypeScript, and modern JavaScript (ES6+).
              </p>
              <p>
          ...
          <motion.div variants={itemVariants} className="md:col-span-3 glass-card rounded-3xl p-8 group hover:bg-white/5 transition-colors duration-700">
